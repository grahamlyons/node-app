...
exports.test = new litmus.Test('Test nano framework', function() {
    ...
    this.is(app.dispatch(mockRequest('GET', '/'), {}), 'Hello', 'Matched route returns content define by function');
    this.is(app.dispatch(mockRequest('HEAD', '/'), {}), 'Hello', 'Route defined for get is also served for head request');
});
